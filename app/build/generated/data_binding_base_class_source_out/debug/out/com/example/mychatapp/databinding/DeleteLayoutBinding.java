...
public final class DeleteLayoutBinding implements ViewBinding {
  ...
  private DeleteLayoutBinding(@NonNull LinearLayout rootView, @NonNull TextView cancel,
  ...
  @NonNull
  public static DeleteLayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DeleteLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.delete_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DeleteLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DeleteLayoutBinding((LinearLayout) rootView, cancel, delete, everyone);
    }
